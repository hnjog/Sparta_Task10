...
void APluginTestCharacter::BeginPlay()
{
	Super::BeginPlay();
...
void APluginTestCharacter::NotifyControllerChanged()
{
...
void APluginTestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APluginTestCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &APluginTestCharacter::Look);
	}
	else
	{
...
void APluginTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APluginTestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
